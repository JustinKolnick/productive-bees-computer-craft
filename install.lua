...
EDIT: I've removed this dependency on an external pastebin and instead put it in this repo at utils/json
]]--
...
local preset = {
    ...
    repo = "productive-bees-computer-craft",
